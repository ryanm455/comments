...
import { USER_COMMENT_QUERY, VOTE_COMMENT_QUERY } from "lib/gqlRequests";
...
export const getServerSideProps: GetServerSideProps<Props> = async ({
  ...
  const comments = await gqlServer(USER_COMMENT_QUERY, {}, { req, res }).then(
    (r: any) => r.data.me.comments
  );
